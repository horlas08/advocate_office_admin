...
class CaseLineChartDesktop extends StatelessWidget {
  CaseLineChartDesktop({super.key, required this.controller});
        ...
        LineChartData(
          ...
          titlesData: FlTitlesData(
            ...
            topTitles: AxisTitles(
              axisNameSize: 40,
              axisNameWidget: Text(
                'بيانات اجمالي الدعاوي لشهر ${DateFormat('MMMM').format(now)}',
                style: TextStyle(
                  color: Theme.of(context).textTheme.headlineMedium!.color,
