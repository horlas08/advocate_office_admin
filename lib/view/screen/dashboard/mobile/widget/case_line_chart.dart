...
class CaseLineChartMobile extends StatelessWidget {
  CaseLineChartMobile({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    final completeData = controller.fillMissingDates(
        controller.caseData, currentYear, currentMonth);
        ...
        LineChartData(
          ...
          titlesData: FlTitlesData(
            ...
            topTitles: AxisTitles(
              axisNameSize: 40,
              axisNameWidget: Text(
                'Case of ${DateFormat('MMMM').format(now)}',
                style: TextStyle(
                  color: Theme.of(context).textTheme.headlineMedium!.color,
