...
import 'dart:convert';
import 'dart:io';
import 'package:advocateoffice/model/payment_invoice.dart';
...
class PaymentInvoiceController extends GetxController {
  ...
  Future<void> generatePaymentInvoice(
    ...
    headerRow.cells[1].value = "التاريخ والوقت";
    headerRow.cells[2].value = "طريقة الدفع";
    headerRow.cells[3].value = "المبلغ المدفوع";
    headerRow.cells[4].value = "المبلغ المستحق";
